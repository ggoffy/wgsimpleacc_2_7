...
\define('_AM_WGSIMPLEACC_PERMISSIONS_ALLOCATION_ADMIN', 'Permissions to edit/delete all allocations');
...
\define('_AM_WGSIMPLEACC_PERMISSIONS_ASSET_ADMIN', 'Permissions to edit/delete all assets');
...
\define('_AM_WGSIMPLEACC_PERMISSIONS_ACCOUNT_ADMIN', 'Permissions to  edit/delete all accounts');
...
\define('_AM_WGSIMPLEACC_PERMISSIONS_BALANCE_ADMIN', 'Permissions to  edit/delete all balances');
...
\define('_AM_WGSIMPLEACC_PERMISSIONS_TRATEMPLATE_ADMIN', 'Permissions to edit/delete all transaction templates');
...
\define('_AM_WGSIMPLEACC_PERMISSIONS_OUTTEMPLATE_ADMIN', 'Permissions to edit/delete all output templates');
