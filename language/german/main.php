...
\define('_MA_WGSIMPLEACC_SHOW_ONLINE', 'Nur Online anzeigen');
...
\define('_MA_WGSIMPLEACC_FILTERBY_PERIOD', 'Zeitraum (Valutadatum) auswählen');
...
// 1.3.4
\define('_MA_WGSIMPLEACC_INVALID_DATE', 'Ungültiges Datum');
