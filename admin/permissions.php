...
$globalPerms = [
    ...
    Constants::PERM_ALLOCATIONS_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_ALLOCATION_ADMIN,
    ...
    Constants::PERM_ASSETS_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_ASSET_ADMIN,
    ...
    Constants::PERM_ACCOUNTS_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_ACCOUNT_ADMIN,
    ...
    Constants::PERM_BALANCES_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_BALANCE_ADMIN,
    ...
    Constants::PERM_TRATEMPLATES_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_TRATEMPLATE_ADMIN,
    ...
    Constants::PERM_OUTTEMPLATES_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_OUTTEMPLATE_ADMIN,
    ...
    Constants::PERM_CLIENTS_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_CLIENT_ADMIN,
    ...
    Constants::PERM_FILEDIR_ADMIN => \_AM_WGSIMPLEACC_PERMISSIONS_FILEDIR_ADMIN,
    Constants::PERM_FILEDIR_SUBMIT => \_AM_WGSIMPLEACC_PERMISSIONS_FILEDIR_SUBMIT,
    Constants::PERM_FILEDIR_VIEW => \_AM_WGSIMPLEACC_PERMISSIONS_FILEDIR_VIEW,
    ];
